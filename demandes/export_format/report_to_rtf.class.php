...
// +-------------------------------------------------+
// $Id: report_to_rtf.class.php,v 1.8 2019-08-26 15:08:38 btafforeau Exp $
...
class report_to_rtf{
	...
	public function generate_RTF(){
		...
		$table->writeToCell(2,1,$this->to_utf8("<u>".$msg['demandes_rapport_abstract']."</u> : "),new PHPRtfLite_Font(12,'Arial','#0E298A'), new PHPRtfLite_ParFormat('center'));
