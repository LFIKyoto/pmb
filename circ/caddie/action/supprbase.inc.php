...
// +-------------------------------------------------+
// $Id: supprbase.inc.php,v 1.4 2015-05-20 11:45:22 jpermanne Exp $
...
if($idemprcaddie) {
	...
	switch ($action) {
		...
		case 'del_base':
			...
			$myCart->compte_items();
			print aff_empr_cart_nb_items ($myCart) ;
			aff_empr_cart_objects ($idemprcaddie, "./circ.php?categ=caddie&sub=gestion&quoi=panier&idemprcaddie=$idemprcaddie", false, 0, true);
			break;
		default:
			break;
	}
