...
$search_form_term = "
<form class='form-$current_module' name='term_search_form' method='post' action='./circ.php?categ=resa_planning&resa_action=search_resa&id_empr=$id_empr&groupID=$groupID&mode=1&unq=$unq&mode=5#search_frame'>
...
<a name='search_frame'/>
<div class='row'>
	<iframe name='term_search' src='".$base_path."/circ/resa_planning/terms/term_browse.php?id_empr=$id_empr&groupID=$groupID&mode=1&unq=$unq&search_term=".rawurlencode(stripslashes($search_term))."&id_thes=".$id_thes."' width=100% height=600>
</div>";
