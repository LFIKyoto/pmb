...
function select($ref, $id) {
	...
	return "window.parent.document.location='../../../circ.php?categ=resa_planning&resa_action=search_resa&mode=2&etat=aut_search&aut_type=$ref&aut_id=$id&id_empr=$id_empr&groupID=$groupID'; return(false);";
	}
