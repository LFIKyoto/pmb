...
// +-------------------------------------------------+
// $Id: pmbesOPACEmpr.class.php,v 1.45.2.2 2019-11-26 10:25:00 btafforeau Exp $
...
class pmbesOPACEmpr extends external_services_api_class{
	...
	public function change_password($session_id, $old_password, $new_password) {
	    global $dbh, $opac_websubscribe_password_regexp;
		...
		if (!preg_match("/$opac_websubscribe_password_regexp/", $new_password)) {
		    return 0;
		}
	...
	public function fetchNoticesCollstates($session_id,$serialIds){
		...
		$this->proxy_parent->isOPAC=true;//Je sauvegarde dans le parent que je viens de l'OPAC pour les droits d'affichage
		$this->proxy_parent->idEmpr=$emprId;//Je sauvegarde dans le parent l'identifiant du lecteur pour les droits d'affichage
