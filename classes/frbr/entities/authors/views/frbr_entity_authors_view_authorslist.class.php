...
// +-------------------------------------------------+
// $Id: frbr_entity_authors_view_authorslist.class.php,v 1.3 2018-06-13 10:34:01 vtouchard Exp $
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $author){
				$render_datas['authors'][] = new authority(0, $author, AUT_TABLE_AUTHORS);
			}
		}
		//on rappelle le tout...
