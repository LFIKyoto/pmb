...
// +-------------------------------------------------+
// $Id: frbr_entity_subcollections_view_subcollectionslist.class.php,v 1.3 2018-06-13 10:34:01 vtouchard Exp $
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $subcollection_id){
				$render_datas['subcollections'][] = new authority(0, $subcollection_id, AUT_TABLE_SUB_COLLECTIONS);
			}
		}
		//on rappelle le tout...
