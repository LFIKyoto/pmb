...
// +-------------------------------------------------+
// $Id: frbr_entity_works_datasource_works_have_expressions.class.php,v 1.7 2017-10-16 15:31:05 tsamson Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class frbr_entity_works_datasource_works_have_expressions extends frbr_entity_works_datasource_works_links {
