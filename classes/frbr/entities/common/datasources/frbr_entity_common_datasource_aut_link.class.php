...
// +-------------------------------------------------+
// $Id: frbr_entity_common_datasource_aut_link.class.php,v 1.6 2018-03-26 09:31:35 dgoron Exp $
...
class frbr_entity_common_datasource_aut_link extends frbr_entity_common_datasource {
	...
	public function get_form(){
		...
		$selector = new marc_select("relationtype_aut", "aut_link_type_parameter", (isset($this->parameters->link_type) ? $this->parameters->link_type : ''), '', 0, $this->msg["frbr_entity_common_datasource_aut_link_all_links"]);
