...
// +-------------------------------------------------+
// $Id: frbr_entity_common_entity_datanode.class.php,v 1.36 2018-08-22 16:23:31 tsamson Exp $
	...
	public function get_filters_selector(){
		...
		if($this->entity_type){
			if($this->entity_type == "concepts") {
				...
				$form.="<img src='".get_url_icon('add.png')."' data-pmb-evt='{\"class\":\"EntityForm\", \"type\":\"click\", \"method\":\"loadDialog\", \"parameters\":{\"element\":\"filter\", \"idElement\":\"".$this->id."\", \"manageId\": 0, \"quoi\" : \"filters\", \"className\" : \"".$this->class_name."\"}}' title=\"".$this->format_text($this->msg['frbr_entity_common_entity_datanode_filter_create'])."\" />";
			}
		} else {
