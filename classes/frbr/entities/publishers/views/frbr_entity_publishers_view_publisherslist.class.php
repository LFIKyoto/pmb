...
// +-------------------------------------------------+
// $Id: frbr_entity_publishers_view_publisherslist.class.php,v 1.3 2018-06-13 10:34:01 vtouchard Exp $
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $publisher_id){
				$render_datas['publishers'][]= new authority(0, $publisher_id, AUT_TABLE_PUBLISHERS);
			}
		}
		//on rappelle le tout...
