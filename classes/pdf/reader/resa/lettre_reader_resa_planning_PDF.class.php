...
// +-------------------------------------------------+
// $Id: lettre_reader_resa_planning_PDF.class.php,v 1.4 2019-08-02 10:49:22 dgoron Exp $
...
class lettre_reader_resa_planning_PDF extends lettre_reader_resa_PDF {
	...
	protected function get_query_list($id_empr) {
		return "select id_resa from resa_planning where resa_idempr='$id_empr' and resa_validee=1 ".$this->get_query_list_order();
	}
