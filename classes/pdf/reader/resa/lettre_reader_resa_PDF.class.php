...
// +-------------------------------------------------+
// $Id: lettre_reader_resa_PDF.class.php,v 1.4 2019-08-02 10:49:22 dgoron Exp $
...
class lettre_reader_resa_PDF extends lettre_reader_PDF {
	...
	protected function get_query_list($id_empr) {
	    return "select id_resa from resa where resa_idempr='$id_empr' and resa_cb is not null and resa_cb!='' ".$this->get_query_list_order();
	}
