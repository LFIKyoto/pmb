...
// +-------------------------------------------------+
// $Id: authperso_admin.class.php,v 1.4 2015-06-23 14:35:34 ngantier Exp $
...
class authperso_admin {
	...
	function delete() {
		global $dbh;		
		$p_perso=new custom_parametres_perso("authperso","authperso",$id_authperso,"./admin.php?categ=authorities&sub=authperso&auth_action=edition&id_authperso=".$this->id,$option_navigation,$option_visibilite);
		$p_perso->delete_all();
