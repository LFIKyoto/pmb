...
// +-------------------------------------------------+
// $Id: onto_ontopmb_datatype_pmbdatatype_selector_ui.class.php,v 1.2 2019-08-14 08:02:58 tsamson Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

require_once $class_path.'/onto/common/onto_common_datatype_ui.class.php';
require_once $include_path.'/templates/onto/ontopmb/onto_ontopmb_datatype_pmbdatatype_selector_ui.tpl.php';
 ...
 * 
 */
class onto_ontopmb_datatype_pmbdatatype_selector_ui extends onto_common_datatype_ui {
...
// 		// 	);
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		$options = "";
		foreach(onto_ontopmb_datatype_pmbdatatype_selector::$options as $value => $msg_key){
		...
		$form=str_replace("!!onto_rows!!",$ontology_tpl['onto_ontopmb_datatype_pmbdatatype_ui'], $form);
