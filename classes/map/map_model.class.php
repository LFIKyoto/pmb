...
// +-------------------------------------------------+
// $Id: map_model.class.php,v 1.19 2015-04-17 12:49:17 vtouchard Exp $
  	...
  	public function get_bounding_box($edit_mode=0) {
  		...
  		if($collection){
			...
			if(pmb_mysql_num_rows($result)){
  			...
  			if($edit_mode) return $bounding_box = new map_hold_polygon("bounding", 0,"polygon((-180 -90,-180 90,180 90,180 -90,-180 -90 ))");
  			return false;
  		}
		return $bounding_box; 
