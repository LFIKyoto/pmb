...
// +-------------------------------------------------+
// $Id: mail_accounting_commande.class.php,v 1.2 2019-08-02 10:49:22 dgoron Exp $
...
class mail_accounting_commande extends mail_accounting {
	
    protected static function get_parameter_prefix() {
		return "acquisition_pdfcde";
	}
	
	protected function get_attachments($id_bibli,$id_cde) {
