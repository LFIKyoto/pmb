...
// +-------------------------------------------------+
// $Id: cms_editorial_parametres_perso.class.php,v 1.20.2.1 2015-12-11 10:37:56 dgoron Exp $
...
class cms_editorial_parametres_perso extends parametres_perso {
	...
	protected function sort_editable_values() {
		$fields = $this->values;
		foreach ($fields as $field_id=>$values) {
			sort($values);
			$this->values[$field_id] = $values;
		}
	}
