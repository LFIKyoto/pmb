...
// +-------------------------------------------------+
// $Id: list_accounting_ui.class.php,v 1.7 2018-12-28 16:31:54 dgoron Exp $
...
// 		}
	...
	protected function get_display_cell($object, $property) {
		if($property == 'print_mail') {
			...
			$display = "<td onclick=\"window.location='".static::get_controller_url_base()."&action=modif&id_bibli=".$this->filters['entite']."&id_exercice=".$this->filters['exercice']."&id_".$this->get_initial_name()."=".$object->id_acte."'\" style='cursor:pointer;'><i>".$this->get_cell_content($object, $property)."</i></td>";
		}
		return $display;
	}
