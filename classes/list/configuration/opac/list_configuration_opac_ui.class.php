...
// +-------------------------------------------------+
// $Id: list_configuration_opac_ui.class.php,v 1.1 2018-10-12 12:18:37 dgoron Exp $
...
class list_configuration_opac_ui extends list_configuration_ui {
	...
	public function __construct($filters=array(), $pager=array(), $applied_sort=array()) {
		static::$module = 'admin';
		static::$categ = 'opac';
		static::$sub = str_replace(array('list_configuration_opac_', '_ui'), '', get_called_class());
