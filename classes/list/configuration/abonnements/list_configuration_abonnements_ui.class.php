...
// +-------------------------------------------------+
// $Id: list_configuration_abonnements_ui.class.php,v 1.1 2018-10-12 11:59:35 dgoron Exp $
...
class list_configuration_abonnements_ui extends list_configuration_ui {
	...
	public function __construct($filters=array(), $pager=array(), $applied_sort=array()) {
		...
		static::$sub = str_replace(array('list_configuration_collstate_', '_ui'), '', get_called_class());
