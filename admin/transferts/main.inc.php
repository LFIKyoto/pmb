...
$tab_param_general = array (
						...
						array (
							"prefix" => "transferts", 
							"nom" => "regroupement_depart", 
							"lib" => $msg ["admin_transferts_regroupement_depart"], 
							"champ" => "adminTransDepart", 
							"type" => "select", 
							"val" => array (
										array ("valeur" => "0", "lib" => $msg ["39"] ), 
										array ("valeur" => "1", "lib" => $msg ["40"] ) 
						...
						array (
							"prefix" => "transferts", 
							"nom" => "pret_demande_statut", 
							"lib" => $msg ["admin_transferts_pret_demande_statut"], 
							"champ" => "admin_demande_statut", 
							"type" => "select", 
							"val" => array (
										array ("valeur" => "0", "lib" => $msg ["39"] ), 
										array ("valeur" => "1", "lib" => $msg ["40"] ) 
...
$tab_param_circ = array (
					...
					array (
						"prefix" => "transferts", 
						"nom" => "retour_action_resa", 
						"lib" => $msg ["admin_transferts_lib_retour_action_resa"], 
						"champ" => "adminTransRetourActionResa", 
						"type" => "select", 
						"val" => array (
									array ("valeur" => "0", "lib" => $msg ["39"] ), 
									array ("valeur" => "1", "lib" => $msg ["40"] ) 
