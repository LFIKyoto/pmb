...
// +-------------------------------------------------+
// $Id: facettes.class.php,v 1.5 2017-10-27 13:39:11 ngantier Exp $
...
class facettes {    
    ...
    public function fetch_data() {
		...
		$myQuery = pmb_mysql_query("SELECT * FROM facettes order by facette_name ", $dbh);
	...
	public function get_form(){
		...
		require_once($base_path."/admin/opac/opac_view/filters/facettes/facettes.tpl.php");
		...
		for($i=0;$i<count($this->liste_item);$i++) {
			$liste_id[] = 'facettes_selected_'.$this->liste_item[$i]->id;
