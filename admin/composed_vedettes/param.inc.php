...
// +-------------------------------------------------+
// $Id: param.inc.php,v 1.1 2018-11-27 16:26:47 apetithomme Exp $
...
switch ($action) {
	case 'save_grammars_by_entity' :
		...
		print "<script type='text/javascript'>window.location.href='./admin.php?categ=composed_vedettes&sub=param&action=grammars_by_entity_form'</script>";
		break;
