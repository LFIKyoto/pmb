...
class sru_analyse_explain extends sru_analyse_request {
	...
	public function process($charset='ISO-8859-1') {
		...
		//Rï¿½cupï¿½ration et vï¿½rification de la suportabilitï¿½ du record schema
		$schema = '';
		$buffer = $dom->get_value('recordschema', $node);
		if (!$schema) {
			//Si pas de schéma, vérifions si on a quand même les données. Soyons laxistes.
