			...
			<tr class='odd'>
				...
				<td>
					<select id='resa_ici_todo' name='resa_ici_todo'>				        
						...
						<option value='4' $resa_ici_todo_selected[4]>".$msg["selfservice_resa_ici_todo_refus"]."</option>
				    </select>
				</td>
				<td>
			...
			<tr class='even'>
				...
				<td>
					<select id='resa_loc_todo' name='resa_loc_todo'>
				        ...
				        <option value='4' $resa_loc_todo_selected[4]>".$msg["selfservice_resa_ici_todo_refus"]."</option>				       
