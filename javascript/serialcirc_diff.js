...
function serialcirc_diff_delete(){		
		
	var num_abt = document.getElementById('num_abt').value;			
	var url= './catalog.php?&categ=serialcirc_diff&sub=delete';		
	url+='&num_abt='+num_abt;
...
function serialcirc_diff_add_caddie(id){
	var url= './ajax.php?module=catalog&categ=serialcirc_diff&sub=get_caddie';	
	url+='&id_caddie='+id;	
