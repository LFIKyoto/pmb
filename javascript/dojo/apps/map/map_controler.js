...
// +-------------------------------------------------+
// $Id: map_controler.js,v 1.69 2015-04-17 12:50:11 vtouchard Exp $
...
//				featureI.attributes.class = featureI.geometry.CLASS_NAME;
		...
		highlightRecord:function(e){
			...
			//console.log('indiceFeature', indiceFeature, 'indiceLayer', indiceLayer);
...
//			}
		...
		validateModification:function(){
			...
			//Recuperer toutes les valeurs des différents inputs, les convertirs & les affecters aux différents pts édités 
...
//	    	domConstruct.destroy(currentLayer.renderer.textRoot);
