...
// +-------------------------------------------------+
// $Id: options_file_box.php,v 1.13 2017-11-07 15:31:19 ngantier Exp $
...
if ($first == 1) {
	...
	<tr><td><?php  echo $msg['include_option_methode']; ?> </td><td><table style='width:100%;vertical-align:center'><tr><td class='center'>Liste <br /><input type="radio" name="METHOD" value="1" <?php if ($param["METHOD"]["0"]["value"]==1) echo "checked";?>></td><td><?php echo $msg['include_option_table']; ?><br /><input type="radio" name="METHOD" value="2" <?php if ($param["METHOD"]["0"]["value"]==2) echo "checked"; ?>></td></tr></table></td></tr>
