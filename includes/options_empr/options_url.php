...
// +-------------------------------------------------+
// $Id: options_url.php,v 1.4 2018-06-21 16:09:19 dgoron Exp $
...
if ($first == 1) {
	...
	$param['LINKTARGET'][0]['value'] = $LINKTARGET ? 1 : 0;
	...
	?>></td></tr>
	<tr><td><?php  echo $msg['persofield_url_linktarget']." (".$msg['persofield_url_linktarget_default_checked'].")";
	?> </td><td><input type="checkbox" name="LINKTARGET" <?php  echo $param['LINKTARGET'][0]['value'] ? ' checked ' : "";
	?>></td></tr>
	</table>
	</div>
