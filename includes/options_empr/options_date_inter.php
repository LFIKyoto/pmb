...
// +-------------------------------------------------+
// $Id: options_date_inter.php,v 1.3 2017-02-24 15:34:34 dgoron Exp $
...
opener.document.formulaire.<?php  echo $name; ?>_for.value="date_inter";
...
<?php 
	...
	if (!isset($param["FOR"]) || $param["FOR"] != "date_inter") {
		$param = array();
		$param["FOR"] = "date_inter";
		$param["DEFAULT_TODAY"][0]["value"] = '';
...
?>
	<form class='form-<?php echo $current_module ?>' name="formulaire" action="options_date_inter.php" method="post">
