...
// +-------------------------------------------------+
// $Id: search.class.php,v 1.2 2017-05-18 15:14:31 dgoron Exp $
...
class last_import_isbn_doublons_expl_search {
    ...
    public function make_search() {
    	...
    	$requete="create temporary table ".$table_tempo." ENGINE=MyISAM SELECT distinct expl_id FROM exemplaires, notices WHERE notice_id=expl_notice AND code IN (".json_decode($_SESSION['last_import_isbn_doublons']).")";
