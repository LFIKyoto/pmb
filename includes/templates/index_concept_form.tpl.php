...
// +-------------------------------------------------+
// $Id: index_concept_form.tpl.php,v 1.4 2014-08-12 12:24:32 apetithomme Exp $
...
$index_concept_form = "
		<div id='el6Child_3' title='".htmlentities($msg['index_concept_label'],ENT_QUOTES, $charset)."' movable='yes'>
			<!--    Concepts    -->
...
$index_concept_text_form = "
		<div id='concept_!!iconcept!!' class='row' dragtype='concept' draggable='yes' recept='yes' recepttype='concept' handler='concept_!!iconcept!!_handle' dragicon=\"".$base_path."/images/icone_drag_notice.png\" dragtext='!!concept_display_label!!' downlight=\"concept_downlight\" highlight=\"concept_highlight\" order='!!iconcept!!' style='' >
			<span id='concept_!!iconcept!!_handle' style='float:left;padding-right:7px;'><img src='".$base_path."/images/sort.png' style='width:12px; vertical-align:middle' /></span>
			<input type='text' class='saisie-80emr' id='concept_!!iconcept!!_display_label' name='concept[!!iconcept!!][display_label]' value=\"!!concept_display_label!!\" completion='onto' att_id_filter='http://www.w3.org/2004/02/skos/core#Concept' autfield=\"concept_!!iconcept!!_value\" autocomplete='off'/>
			...
			<input type='hidden' name='concept[!!iconcept!!][value]' id='concept_!!iconcept!!_value' value='!!concept_uri!!' />
			<input type='hidden' name='concept[!!iconcept!!][type]' id='concept_!!iconcept!!_type' value='!!concept_type!!' />
		</div>";
...
<a class='lien_gestion' href='./autorites.php?categ=concepts&sub=concept&action=edit&id=!!concept_id!!'>!!concept_display_label!!</a>
";