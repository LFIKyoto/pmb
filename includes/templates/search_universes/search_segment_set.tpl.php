...
// +-------------------------------------------------+
// $Id: search_segment_set.tpl.php,v 1.3.2.1 2019-09-12 07:52:20 tsamson Exp $
...
<div class='row'>
    ...
    <img src='".get_url_icon('b_edit.png')."' id='edit_segment_set' data-pmb-evt='{\"class\":\"SegmentForm\", \"type\":\"click\", \"method\":\"loadSetDialog\", \"parameters\":{\"module\":\"selectors\", \"what\" : \"!!segment_type!!\", \"action\" : \"advanced_search\", \"entity_id\" : \"!!segment_id!!\", \"entity_type\" : \"segment\", \"authperso_id\" : \"!!authperso_id!!\"}}' title=\"".htmlentities($msg['search_segment_add_set'],ENT_QUOTES,$charset)."\" />   
