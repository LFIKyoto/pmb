...
if ($cms_active && (SESSrights & CMS_AUTH)) {
	...
	$menu_bar.= "title='".htmlentities($msg['cms_onglet_title'],ENT_QUOTES, $charset)."' href='./cms.php?categ=editorial&sub=list' >".$msg['cms_onglet_title']."</a></li>";
}
...
if ( !function_exists("auto_hide_getprefs") || ((SESSrights & RESTRICTCIRC_AUTH) && ($categ!="pret") && ($categ!="pretrestrict") &&  ($presence_chaine != false))) {
	...
	if(isset($aff_alerte)) $aff_alerte="<div class='erreur'>$aff_alerte</div>";
