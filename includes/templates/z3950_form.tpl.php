...
<script>
    function fonction_selecteur_auteur() {
        ...
        openPopUp('./select.php?what=auteur&caller=notice&param1='+name_id+'&param2='+name+'&dyn=1&deb_rech='+".pmb_escape()."(document.getElementById(name).value), 'select_author2', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes');
    }
			...
			<blockquote>
				...
				<div class='row'>
					...
					<div class='colonne_suite'>
						...
						<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=function&caller=notice&p1=f_author_function_0&p2=f_author_function_label_0', 'select_func1', 400, 400, -2, -2, '$select2_prop')\" />
...
$ptab[12] = "<br />
		...
		<blockquote>
			...
			<div class='row'>
				<div class='colonne2'>
					<input type='text' class='saisie-20emr' name='f_author_name_2!!iaut!!' value=\"!!author_name_2!!\" />
					<input type='text' class='saisie-15emr' name='f_author_rejete_2!!iaut!!' value=\"!!author_rejete_2!!\" />
					<input type='text' class='saisie-15emr' name='f_authority_number_2!!iaut!!' value=\"!!authority_number_2!!\" />
				</div>
				<div class='colonne_suite' >
			...
			<div class='row'>
				<div class='colonne4' id='div_author_date_2!!iaut!!'>
					<input type='text' class='saisie-20emr' name='f_author_date_2!!iaut!!' id='f_author_date_2!!iaut!!' value=\"!!author_date_2!!\" />
				</div>
				<div class='colonne4' id='div_author_lieu_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
					<input type='text' class='saisie-20emr' name='f_author_lieu_2!!iaut!!' id='f_author_lieu_2!!iaut!!' value=\"!!author_lieu_2!!\" />
				</div>
				<div class='colonne_suite' id='div_author_pays_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
					<input type='text' class='saisie-20emr' name='f_author_pays_2!!iaut!!' id='f_author_pays_2!!iaut!!' value=\"!!author_pays_2!!\" />
				</div>	
			</div>
			<div class='row'>
				...
				<div class='row'>
					<div class='colonne4' id='div_author_ville_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
						<input type='text' class='saisie-20emr' name='f_author_ville_2!!iaut!!' id='f_author_ville_2!!iaut!!' value=\"!!author_ville_2!!\" />
					</div>
					<div class='colonne4' id='div_author_subdivision_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
						<input type='text' class='saisie-20emr' name='f_author_subdivision_2!!iaut!!' id='f_author_subdivision_2!!iaut!!' value=\"!!author_subdivision_2!!\" />
					</div>
					<div class='colonne_suite' id='div_author_numero_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
						<input type='text' class='saisie-20emr' name='f_author_numero_2!!iaut!!' id='f_author_numero_2!!iaut!!' value=\"!!author_numero_2!!\" />
					</div>					
				</div>
				<div class='row'>
				...
				<div class='row'>
					<div class='colonne' id='div_author_web_2!!iaut!!' style='display:!!display_2!!iaut!!!!'>
						<input type='text' class='saisie-80emr' name='f_author_web_2!!iaut!!' id='f_author_web_2!!iaut!!' value=\"!!author_web_2!!\" maxlength='255' />
				...
				<div class='row'>
					<div class='colonne'>
						<textarea class='saisie-80emr' id='f_author_comment_2!!iaut!!' name='f_author_comment_2!!iaut!!' cols='62' rows='4' wrap='virtual'>!!author_comment_2!!</textarea>
					</div>
				</div>
			<br />	
			<hr style='margin: 2px 0 2px 0;'>
...
<div id='el2Child' class='child' >
	...
	<blockquote>
		...
		<div id='el2Child_0b' class='row'>
		    ...
		    <input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=editeur&caller=notice&p1=f_ed1_id&p2=f_ed1&p3=f_coll_existing_id&p4=f_coll_existing&p5=f_subcoll_existing_id&p6=f_subcoll_existing&deb_rech='+this.form.f_ed1.value, 'select_ed1', 400, 400, -2, -2, '$select1_prop')\" />
	...
	<blockquote>
		<div class='row'>
	        ...
	        <div class='colonne_suite'>
				...
				<div class='row'>
					<div class='row'>
						<input type='text' class='saisie-30emr' id='f_editor_ville_1' name='f_editor_ville_1' value=\"!!editor_ville_1!!\" />
					</div>
				</div>
		    </div>
		</div>
...
<div id='el6Child' class='child' etirable='yes' title='".htmlentities($msg[269],ENT_QUOTES, $charset)."'>
	...
	<div id=\"div_categorisation_manual\" class='child'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=categorie&caller=notice&autoindex_class=autoindex_record&htmlfieldstype=html_ext&indexation_lang=!!indexation_lang_sel!!&p1=f_categ_id&p2=f_categ&dyn=1&parent=0', 'select_categ', 700, 500, -2, -2, '$select_categ_prop')\" />
		<input type='button' class='bouton' value='+' onClick=\"add_categ();\"/>	
	   	<div id='el6Child_0'>
		  	<div id='drag_0'  class='row' dragtype='categ' draggable='yes' recept='yes' recepttype='categ' handler='handle_0'		
				dragicon=\"".$base_path."/images/icone_drag_notice.png\" dragtext='' downlight=\"categ_downlight\" highlight=\"categ_highlight\"			
				order='0' style='' >
		 		<span id=\"handle_0\" style=\"float:left; padding-right : 7px\"><img src=\"".$base_path."/images/sort.png\" style='width:12px; vertical-align:middle' /></span>
