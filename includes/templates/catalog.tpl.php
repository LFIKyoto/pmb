...
<ul>
	...
	if ($opac_avis_allow) $catalog_menu .=	"<li><a href='./catalog.php?categ=avis&sub=records'>".$msg["menu_gestion_avis"]."</a></li>";
...
if ($pmb_contribution_area_activate) {
	$catalog_menu.= "<h3 onclick='menuHide(this,event)'>".$msg["catalog_menu_contribution"]."</h3>
	<ul>
		<li><a href='./catalog.php?categ=contribution_area&action=list'>".$msg["contribution_area_moderation"]."</a></li>
	</ul>"; 
}
$plugins = plugins::get_instance();
$catalog_menu.= $plugins->get_menu('catalog')."
...
<div class='hmenu'>
	...
	<span".ongletSelect("categ=caddie&sub=pointage&moyen=panier").">
		<a title='".$msg["caddie_menu_pointage_panier"]."' href='./catalog.php?categ=caddie&sub=pointage&moyen=panier'>
			".$msg["caddie_menu_pointage_panier"]."
		</a>
	</span>
	<span".ongletSelect("categ=caddie&sub=pointage&moyen=search_history").">
		<a title='".$msg["caddie_menu_pointage_search_history"]."' href='./catalog.php?categ=caddie&sub=pointage&moyen=search_history'>
			".$msg["caddie_menu_pointage_search_history"]."
		</a>
	</span>
...
if((SESSrights & CIRCULATION_AUTH) && $pmb_scan_request_activate){
	...
	<span".ongletSelect("categ=caddie&sub=action&quelle=scan_request").">
		<a title='".$msg["scan_request_record_button"]."' href='./catalog.php?categ=caddie&sub=action&quelle=scan_request'>
			".$msg["scan_request_record_button"]."
		</a>
	</span>";
} else {
	$scan_request_record_button="";
...
$catalog_menu_panier_action.= "
	<span".ongletSelect("categ=caddie&sub=action&quelle=reindex").">
		<a title='".$msg["caddie_menu_action_reindex"]."' href='./catalog.php?categ=caddie&sub=action&quelle=reindex'>
			".$msg["caddie_menu_action_reindex"]."
		</a>
	</span>";
if($gestion_acces_active){
	$catalog_menu_panier_action .= "
	<span".ongletSelect("categ=caddie&sub=action&quelle=access_rights").">
		<a title='".$msg["caddie_menu_action_access_rights"]."' href='./catalog.php?categ=caddie&sub=action&quelle=access_rights'>
			".$msg["caddie_menu_action_access_rights"]."
		</a>
	</span>";
}
$catalog_menu_panier_action .= "
...
if ($pmb_transferts_actif) {
	$catalog_menu_panier_action.= "
	<span".ongletSelect("categ=caddie&sub=action&quelle=transfert_to_location").">
		<a title='".$msg["caddie_menu_action_transfert_to_location"]."' href='./catalog.php?categ=caddie&sub=action&quelle=transfert_to_location'>
			".$msg["caddie_menu_action_transfert_to_location"]."
		</a>
	</span>";
}
// Fin Hmenu
