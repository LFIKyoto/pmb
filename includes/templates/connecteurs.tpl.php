...
// +-------------------------------------------------+
// $Id: connecteurs.tpl.php,v 1.15 2019-08-22 09:44:33 btafforeau Exp $
...
<form onsubmit='return test_form();' name='source_form' action='admin.php?categ=connecteurs&sub=in&id=!!id!!&source_id=!!source_id!!' method='post' class='form-$current_module' enctype='multipart/form-data'>
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<div class='colonne3'><label for='name'>".$msg["connecteurs_ico_notice"]."</label></div><div class='colonne_suite'><input type='text' name='ico_notice' id='ico_notice' value='!!ico_notice!!' class='saisie-30em'/></div>
		</div>
		!!enrichment!!
		<div class='row'>	
			!!special_form!!
