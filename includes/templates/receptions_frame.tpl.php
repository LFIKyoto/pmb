...
$recept_bt_update = "<input type='button' class='bouton_small' value='".htmlentities($msg['acquisition_recept_deliv_save'],ENT_QUOTES, $charset)."' onclick='recept_update(this.form);' />";
