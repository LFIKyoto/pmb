...
// +-------------------------------------------------+
// $Id: cms_editorial.tpl.php,v 1.25.2.2 2015-11-26 08:38:53 jpermanne Exp $
...
$cms_editorial_form_audit_button_tpl = "
			<input type='button' class='bouton' onclick='openPopUp(\"./audit.php?type_obj=!!cms_editorial_form_audit_type!!&object_id=!!cms_editorial_form_obj_id!!\", \"audit_popup\", 700, 500, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")' value='".$msg['audit_button']."'/>
";
...
$cms_editorial_type_field = "
			<div class='row'>
				<div class='colonne'>
					...
					<div class='row'>
						<select name='cms_editorial_form_type' id='cms_editorial_form_type' onchange='cms_editorial_load_type_form(this.value, this)'>
