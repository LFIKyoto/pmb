...
$bt_imp = "<input type='button' class='bouton' value='".$msg['imprimer']."' title='".$msg['imprimer']."' onclick=\"openPopUp('./pdf.php?pdfdoc=cmde&id_bibli=".$id_bibli."&id_cde=".$id_cde."' ,'print_PDF', 600, 500, -2, -2, 'toolbar=no, dependent=yes, resizable=yes')\" />";
			...
			<table class='act_cell' >
				<tbody id='act_tab'>
					<tr>
						...
						<th width='4%'>".htmlentities($msg['acquisition_act_tab_qte'], ENT_QUOTES, $charset)."<br />".htmlentities($msg['acquisition_act_tab_rec_par'], ENT_QUOTES, $charset)."</th>";
switch ($acquisition_gestion_tva) {
	case '1' :
		$valid_cde_form.= "
