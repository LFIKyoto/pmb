...
// +-------------------------------------------------+
// $Id: vedette_indexint.tpl.php,v 1.1 2014-08-08 13:29:22 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $vedette_indexint_tpl, $msg;

$vedette_indexint_tpl['vedette_indexint_selector']='
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_form" class="vedette_composee_element_form">
	...
	<input type="hidden" name="!!caller!!_!!property_name!![!!vedette_composee_order!!][elements][!!vedette_composee_subdivision_id!!][!!vedette_composee_element_order!!][type]" value="vedette_indexint" />
</div>
';

$vedette_indexint_tpl['vedette_indexint_script']='
var vedette_indexint = {
	...
	create_box : function(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
		...
		text.setAttribute("completion", "indexint");
		text.setAttribute("autocompletion", "on");
		text.setAttribute("autocomplete", "off");
		text.setAttribute("placeholder", "['.$msg["vedette_indexint"].']");
		text.setAttribute("vedettetype", "vedette_indexint");
		if (label) {
		...
		element_type.setAttribute("value", "vedette_indexint");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "['.$msg["vedette_indexint"].'] " + document.getElementById(id).value;
	}
}
';