...
// +-------------------------------------------------+
// $Id: vedette_common.tpl.php,v 1.3 2014-08-11 10:24:41 apetithomme Exp $
...
<script type="text/javascript">
	var !!caller!!_!!property_name!!_!!vedette_composee_order!!_tab_vedette_elements = !!tab_vedette_elements!!;
	var !!caller!!_!!property_name!!_!!vedette_composee_order!!_separator = "!!vedette_separator!!";
	...
	var vedette_element =  {
		...
		create_box : function(vedette_type, parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.create_box(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel);
		},
		
		update_box : function(vedette_type, parent, vedette_composee_subdivision_id, vedette_composee_element_order) {
			...
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.create_box(parent, vedette_composee_subdivision_id, vedette_composee_element_order, element_id.value, text.value, text.getAttribute("rawlabel"));
		},
		
		callback : function(vedette_type, id) {
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.callback(id);
			vedette_composee_update_all("!!caller!!_!!property_name!!_!!vedette_composee_order!!_vedette_composee_subdivisions");
		}
	}
...
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_vedette_composee_corp" class="vedette_composee_corp">
	...
	<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_vedette_composee_available_fields" class="vedette_composee_available_fields">
			!!vedette_composee_available_fields!!
		<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_vedette_composee_delete_element" recept="yes" recepttype="vedette_composee_delete_element" highlight="vedette_element_highlight" downlight="vedette_element_downlight"><img src="'.$base_path.'/images/suppr_all.gif"/></div>
	</div>
...
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_vedette_composee_available_field_!!available_field_id!!" class="vedette_composee_available_field" draggable="yes" dragtype="vedette_composee_available_fields" dragtext="!!vedette_composee_available_field_label!!" vedettetype="!!available_field_type!!" >
...
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!" class="vedette_composee_element" dragtype="vedette_composee_element" recepttype="vedette_composee_element" draggable="yes" recept="yes" order="!!vedette_composee_element_order!!" highlight="vedette_element_highlight" downlight="vedette_element_downlight" vedettetype="!!vedette_composee_element_type!!" handler="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_handler" >
	<span id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_handler" style="float:left;padding-right:7px;" >
		<img src="./images/drag_symbol.png" style="vertical-align:middle;" />
	</span>
