...
// +-------------------------------------------------+
// $Id: vedette_publishers.tpl.php,v 1.2 2014-08-08 13:29:22 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $vedette_publishers_tpl, $msg;

$vedette_publishers_tpl['vedette_publishers_selector']='
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_form" class="vedette_composee_element_form">
	...
	<input type="hidden" name="!!caller!!_!!property_name!![!!vedette_composee_order!!][elements][!!vedette_composee_subdivision_id!!][!!vedette_composee_element_order!!][type]" value="vedette_publishers" />
</div>
';

$vedette_publishers_tpl['vedette_publishers_script']='
var vedette_publishers = {
	...
	create_box : function(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
		...
		text.setAttribute("completion", "publishers");
		text.setAttribute("autocompletion", "on");
		text.setAttribute("autocomplete", "off");
		text.setAttribute("placeholder", "['.$msg["vedette_publishers"].']");
		text.setAttribute("vedettetype", "vedette_publishers");
		if (label) {
		...
		element_type.setAttribute("value", "vedette_publishers");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "['.$msg["vedette_publishers"].'] " + document.getElementById(id).value;
	}
}
';