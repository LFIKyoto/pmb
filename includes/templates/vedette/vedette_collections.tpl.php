...
// +-------------------------------------------------+
// $Id: vedette_collections.tpl.php,v 1.2 2014-08-08 13:29:22 apetithomme Exp $
...
var vedette_collections = {
	...
	create_box : function(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
		...
		text.setAttribute("placeholder", "['.$msg["vedette_collections"].']");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "['.$msg["vedette_collections"].'] " + document.getElementById(id).value;
	}
}
';