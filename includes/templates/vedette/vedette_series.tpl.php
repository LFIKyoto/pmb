...
// +-------------------------------------------------+
// $Id: vedette_series.tpl.php,v 1.2 2014-08-08 14:22:59 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $vedette_series_tpl, $msg;

$vedette_series_tpl['vedette_series_selector']='
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_form" class="vedette_composee_element_form">
	...
	<input type="hidden" name="!!caller!!_!!property_name!![!!vedette_composee_order!!][elements][!!vedette_composee_subdivision_id!!][!!vedette_composee_element_order!!][type]" value="vedette_series" />
</div>
';

$vedette_series_tpl['vedette_series_script']='
var vedette_series = {
	...
	create_box : function(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
		...
		text.setAttribute("completion", "serie");
		text.setAttribute("autocompletion", "on");
		text.setAttribute("autocomplete", "off");
		text.setAttribute("placeholder", "['.$msg["vedette_series"].']");
		text.setAttribute("vedettetype", "vedette_series");
		if (label) {
		...
		element_type.setAttribute("value", "vedette_series");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "['.$msg["vedette_series"].'] " + document.getElementById(id).value;
	}
}
';