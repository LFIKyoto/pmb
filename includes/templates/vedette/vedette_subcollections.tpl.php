...
// +-------------------------------------------------+
// $Id: vedette_subcollections.tpl.php,v 1.1 2014-08-08 13:29:22 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

global $vedette_subcollections_tpl, $msg;

$vedette_subcollections_tpl['vedette_subcollections_selector']='
<div id="!!caller!!_!!property_name!!_!!vedette_composee_order!!_!!vedette_composee_subdivision_id!!_element_!!vedette_composee_element_order!!_form" class="vedette_composee_element_form">
	...
	<input type="hidden" name="!!caller!!_!!property_name!![!!vedette_composee_order!!][elements][!!vedette_composee_subdivision_id!!][!!vedette_composee_element_order!!][type]" value="vedette_subcollections" />
</div>
';

$vedette_subcollections_tpl['vedette_subcollections_script']='
var vedette_subcollections = {
	...
	create_box : function(parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel) {
		...
		text.setAttribute("completion", "subcollections");
		text.setAttribute("autocompletion", "on");
		text.setAttribute("autocomplete", "off");
		text.setAttribute("placeholder", "['.$msg["vedette_subcollections"].']");
		text.setAttribute("vedettetype", "vedette_subcollections");
		if (label) {
		...
		element_type.setAttribute("value", "vedette_subcollections");
	...
	callback : function(id) {
		...
		document.getElementById(id).value = "['.$msg["vedette_subcollections"].'] " + document.getElementById(id).value;
	}
}
';