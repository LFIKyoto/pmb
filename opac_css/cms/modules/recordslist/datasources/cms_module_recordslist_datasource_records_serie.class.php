...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_datasource_records_serie.class.php,v 1.1 2015-04-10 10:29:04 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_recordslist_datasource_records_serie extends cms_module_common_datasource_list{
		...
		if ($selector) {
			...
			if($value['serie'] != 0){
				...
				if(pmb_mysql_num_rows($result) > 0){
					$return["title"] = "Dans la même série";
					$records = array();
