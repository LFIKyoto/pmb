...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_datasource_records_publisher.class.php,v 1.1 2015-04-10 10:29:04 apetithomme Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_recordslist_datasource_records_publisher extends cms_module_common_datasource_list{
