...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_datasource_records_indexint.class.php,v 1.3 2016-09-20 10:25:41 apetithomme Exp $
...
class cms_module_recordslist_datasource_records_indexint extends cms_module_common_datasource_records_list{
	...
	public function get_datas(){
		...
		if ($selector) {
			...
			if($value['indexint'] != 0){
				$query = "select notice_id from notices where indexint = '".($value['indexint']*1)."' and notice_id != '".($value['record']*1)."'";
