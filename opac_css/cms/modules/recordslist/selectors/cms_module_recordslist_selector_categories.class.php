...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_selector_categories.class.php,v 1.1 2015-04-10 10:29:04 apetithomme Exp $
	...
	public function get_value(){
		...
		if(!$this->value){
			...
			if($sub_selector->get_value()){
				...
				$query = "select GROUP_CONCAT(num_noeud SEPARATOR ',') as categs from notices_categories where notcateg_notice = ".$sub_selector->get_value();
