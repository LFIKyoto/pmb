...
// +-------------------------------------------------+
// $Id: cms_module_agenda_view_carousel_responsive.class.php,v 1.2.6.1 2019-09-17 09:59:20 tsamson Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_agenda_view_carousel_responsive extends cms_module_common_view_carousel_responsive {
