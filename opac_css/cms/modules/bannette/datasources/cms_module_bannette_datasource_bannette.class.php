...
// +-------------------------------------------------+
// $Id: cms_module_bannette_datasource_bannette.class.php,v 1.1.2.2 2015-10-06 07:08:25 dgoron Exp $
	...
	public function get_datas(){
		...
		if ($selector) {
			...
			if(is_array($id_bannette) && count($id_bannette)){
				$query = "select id_bannette, nom_bannette, comment_public, entete_mail, piedpage_mail from bannettes where id_bannette = ".$id_bannette[0];
