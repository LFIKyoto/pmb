...
// +-------------------------------------------------+
// $Id: cms_module_common_selector_type_section_generic.class.php,v 1.5 2016-02-24 11:13:07 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");

class cms_module_common_selector_type_section_generic extends cms_module_common_selector{
	...
	protected function gen_select(){
		...
		$select.= "
				<option value='0'>".$this->format_text($this->msg['cms_module_common_selector_section_generic_type_select_invit'])."</option>";		
		if(pmb_mysql_num_rows($result)){
			...
			$select.= "
				<option value ='0'>".$this->format_text($this->msg['cms_module_common_selector_section_generic_type_no'])."</option>";
		}		
		$select.= "</select>";
