...
// +-------------------------------------------------+
// $Id: cms_module_common_datasource_searcharticles.class.php,v 1.9 2015-04-09 16:19:51 arenou Exp $
	...
	public function get_datas(){
		...
		if($selector) {
			if($selector->get_value() != ""){
				$searcher = new cms_editorial_searcher($selector->get_value(),"article");
