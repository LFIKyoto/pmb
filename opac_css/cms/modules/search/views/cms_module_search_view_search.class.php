...
class cms_module_search_view_search extends cms_module_common_view{
	...
	public function render($datas){
		...
		global $opac_modules_search_concept;
		...
		<script type='text/javascript'>
			function ".$this->get_module_dom_id()."_change_dest(){
				...
				if (page.indexOf('view_') != -1) {
					...
					document.forms['".$this->get_module_dom_id()."_searchbox'].action = (universe?'./index.php?lvl=search_universe&id='+universe:document.forms['".$this->get_module_dom_id()."_searchbox'].action)+'&opac_view='+view_id;
				} else if(page>0){
