...
// +-------------------------------------------------+
// $Id: ontology.tpl.php,v 1.3 2018-12-28 16:19:06 tsamson Exp $
...
<input type='button' class='bouton' onclick=\"\" value='".$msg["onto_contribution_delete_button"]."' />
";
...
$ontology_tpl['object'] = "
<div class='row'>
<input type='text' id='!!fname!!_!!index!!' name='!!fname!![!!index!!]' class='saisie-80emr' value='!!value!!' aut_field='f_!!fname!!_!!index!!' completion='!!range!!' /><!-- p_sel_button --><!-- p_del_button --><!-- p_add_button -->
