...
global $include_path, $categ_browser, $msg, $current_module, $charset;
...
<div class='row'>
	<div class='left'>
		...
		<input type='submit' id='btsubmit' class='bouton' value='$msg[77]' onClick=\"return test_form(this.form)\" />
		<!-- remplace_categ -->
		!!voir_notices!!
		!!audit_bt!!
