...
function check_uncheck_all_cart() {
	if (cart_all_checked) {
		...
		document.getElementById('show_cart_checked_all').value = '".$msg["show_cart_check_all"]."';
		document.getElementById('show_cart_checked_all').title = '".$msg["show_cart_check_all"]."';
	} else {
		setCheckboxes('cart_form', 'notice', true);
		cart_all_checked = true;
		document.getElementById('show_cart_checked_all').value = '".$msg["show_cart_uncheck_all"]."';
		document.getElementById('show_cart_checked_all').title = '".$msg["show_cart_uncheck_all"]."';
	}
	return false;
}
...
if (count($cart_)) {
	...
	if($opac_resa && $id_empr && $opac_resa_cart){
