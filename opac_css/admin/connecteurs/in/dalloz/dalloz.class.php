...
// +-------------------------------------------------+
// $Id: dalloz.class.php,v 1.2.4.6 2019-11-04 10:14:48 btafforeau Exp $
...
class dalloz extends connector {
    ...
    public function rec_record($record,$source_id,$search_id) {
        ...
        if (($this->del_old)||((!$this->del_old)&&(!$ref_exists))) {
            ...
            //Type de document
            $value = urldecode($urMetas->categorie);
            if (array_key_exists($value, $this->listeTypedoc)) {
                $value = $this->listeTypedoc[$urMetas->categorie];
            }
            $to_insert[]=["ufield"=>"900","usubfield"=>"a","field_order"=>0,"value"=>$value];
