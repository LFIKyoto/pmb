...
// +-------------------------------------------------+
// $Id: frbr_entity_common_datasource_aut_link.class.php,v 1.6 2017-09-15 14:47:30 vtouchard Exp $
...
class frbr_entity_common_datasource_aut_link extends frbr_entity_common_datasource {
	...
	public function get_form(){
		...
		$selector = new marc_select("relationtype_aut", "aut_link_type_parameter", $this->parameters->link_type, '', 0, $this->msg["frbr_entity_common_datasource_aut_link_all_links"]);
