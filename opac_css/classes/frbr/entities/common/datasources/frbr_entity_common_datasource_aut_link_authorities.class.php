...
// +-------------------------------------------------+
// $Id: frbr_entity_common_datasource_aut_link_authorities.class.php,v 1.4 2017-09-15 10:06:14 vtouchard Exp $
...
class frbr_entity_common_datasource_aut_link_authorities extends frbr_entity_common_datasource {
	...
	protected function get_sub_query($datas=array()) {
		...
		$sub_query .= " AND aut_link_reciproc = 1 AND aut_link_to_num IN (".implode(',', $datas).")";
		return $sub_query;
	}
