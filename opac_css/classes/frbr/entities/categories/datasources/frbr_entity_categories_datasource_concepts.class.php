...
// +-------------------------------------------------+
// $Id: frbr_entity_categories_datasource_concepts.class.php,v 1.5 2017-09-15 10:06:14 vtouchard Exp $
...
class frbr_entity_categories_datasource_concepts extends frbr_entity_common_datasource_concept {
	...
	public function get_datas($datas=array()){
		$query = "select distinct index_concept.num_concept as id, index_concept.num_object as parent FROM index_concept
			WHERE index_concept.type_object = 3 AND index_concept.num_object IN (".implode(',', $datas).")";
