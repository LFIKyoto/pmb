...
// +-------------------------------------------------+
// $Id: authority_page_serie.class.php,v 1.3 2018-07-27 14:32:26 tsamson Exp $
...
class authority_page_serie extends authority_page {
	...
	public function __construct($id) {
		...
		if($result && pmb_mysql_num_rows($result)){
			...
			$this->authority = authorities_collection::get_authority('authority', 0, ['num_object' => $this->id, 'type_object' => AUT_TABLE_SERIES]);
		}
	}
