...
// +-------------------------------------------------+
// $Id: caddie_controller.class.php,v 1.3.6.1 2019-10-14 14:44:28 dgoron Exp $
	...
	public static function proceed($id=0) {
		...
		switch ($lvl) {
			...
			case "subcoll_see":
				...
				break;
			case "etagere_see":
				$q = "select distinct object_id as notice_id from caddie_content join etagere_caddie on caddie_content.caddie_id=etagere_caddie.caddie_id where etagere_id='$id'";
