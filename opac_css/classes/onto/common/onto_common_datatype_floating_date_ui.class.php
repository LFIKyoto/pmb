...
// +-------------------------------------------------+
// $Id: onto_common_datatype_floating_date_ui.class.php,v 1.2 2019-08-23 12:37:58 btafforeau Exp $
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if (!empty($datas)) {
		    ...
		    foreach($datas as $key=>$data){
		        ...
		        $inside_row=str_replace("!!floating_date_comment!!", (isset($formated_value[3]) ? $formated_value[3] : ''), $inside_row);
