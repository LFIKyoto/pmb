...
// +-------------------------------------------------+
// $Id: onto_common_datatype_checkbox_ui.class.php,v 1.3 2017-09-04 12:47:43 tsamson Exp $

if (stristr($_SERVER['REQUEST_URI'], ".class.php")) die("no access");


/**
 * class onto_common_datatype_radio_ui
 * 
 */
class onto_common_datatype_checkbox_ui extends onto_common_datatype_ui {
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if(sizeof($datas)){
			...
			foreach($datas as $key=>$data){
				...
				$inside_row=$ontology_tpl['form_row_content_checkbox'];
				$inside_row .= $ontology_tpl['form_row_content_type'];
				
				$inside_row=str_replace("!!onto_row_content_checkbox_checked!!", $data->get_value() ? "checked='checked'" : "", $inside_row);
			...
			$inside_row=str_replace("!!onto_row_content_checkbox_checked!!", "", $inside_row);
