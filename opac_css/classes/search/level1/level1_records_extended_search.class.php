...
// +-------------------------------------------------+
// $Id: level1_records_extended_search.class.php,v 1.1 2018-04-17 12:48:16 dgoron Exp $
...
class level1_records_extended_search extends level1_records_search {
	...
	protected function get_display_link_affiliate() {
		...
		if($this->get_nb_results()){
			return "<a href='#' onclick=\"document.".$this->get_hidden_search_form_name().".action = '".$this->get_form_action()."&mode=extended&tab=catalog'; enable_operators(); document.".$this->get_hidden_search_form_name().".submit();return false;\">".$msg['suite']."&nbsp;<img src='".get_url_icon('search.gif')."' style='border:0px' align='absmiddle'/></a>";
		}else {
			return "";
		}
	}
	...
	protected function get_display_result() {
		...
		$display .= "<a href=\"#\" onclick=\"document.".$this->get_hidden_search_form_name().".action='".$this->get_form_action()."&mode=extended'; enable_operators(); document.".$this->get_hidden_search_form_name().".submit(); return false;\">".$msg['suite']."&nbsp;<img src='".get_url_icon('search.gif')."' style='border:0px' align='absmiddle'/></a><br /><br />";
		return $display;
	}
