...
class categories{
	...
	static function exists($num_noeud, $langue) {
	...
	static function listAncestorNames($num_noeud=0, $langue='') {
	...
	function listSynonymes($num_noeud=0, $langue, $keep_tilde=1, $ordered=0) {
