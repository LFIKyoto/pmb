...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_datasource_records_publisher.class.php,v 1.3 2016-09-20 10:25:41 apetithomme Exp $
	...
	public function get_datas(){
		...
		if ($selector) {
			...
			if($value['publisher'] != 0){
				$query = "select notice_id from notices where ed1_id = '".($value['publisher']*1)."' and notice_id != '".($value['record']*1)."'";
