...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_selector_collection.class.php,v 1.2 2016-09-20 10:25:41 apetithomme Exp $
	...
	public function get_value(){
		...
		if(!$this->value){
			...
			if($sub_selector->get_value()*1){
				...
				$query = "select coll_id from notices where notice_id = '".($sub_selector->get_value()*1)."'";
