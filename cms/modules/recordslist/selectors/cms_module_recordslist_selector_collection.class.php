...
// +-------------------------------------------------+
// $Id: cms_module_recordslist_selector_collection.class.php,v 1.1 2015-04-10 10:29:04 apetithomme Exp $
	...
	public function get_value(){
		...
		if(!$this->value){
			...
			if($sub_selector->get_value()){
				...
				$query = "select coll_id from notices where notice_id = ".$sub_selector->get_value();
