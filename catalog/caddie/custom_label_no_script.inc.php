...
$label_con['s0']['font'][0] 			= $pmb_pdf_fontfixed;
...
$label_con['s1']['font'][0] 			= $pmb_pdf_fontfixed;
...
$label_con['s2']['font'][0] 			= $pmb_pdf_fontfixed;
...
function display_cote_content($label_id, $step) {
	...
	$r.= "<div class='row'>
			<div class='left'>".htmlentities($msg['font_color'], ENT_QUOTES, $charset)."</div>
			<div class='right'>
				<input type='text' id='content_value[".$step."][font_color]' name='content_value[".$step."][font_color]' class='saisie-5em' style='text-align:right;' value='".$label_con[$label_id]['font_color'][$step]."' />
			</div>
		</div>";
