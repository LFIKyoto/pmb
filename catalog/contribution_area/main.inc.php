...
print "<h1>".$msg["catalog_menu_contribution"]." > ".$msg["contribution_area_moderation"]."</h1>" ;
...
switch($action) {
	...
	default:
		...
		print $h2o->render(array('forms' => contribution_area_forms_controller::get_moderation_forms()));
		break;
}
