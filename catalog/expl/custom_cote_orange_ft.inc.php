...
// +-------------------------------------------------+
// $Id: custom_cote_orange_ft.inc.php,v 1.5 2015-04-03 11:16:19 jpermanne Exp $
...
function prefill_cote($id_notice=0,$cote="") {
	...
	if (!$cote) {
		...
		$requete = "SELECT substr(indexint_name,2) as index_cote FROM indexint, notices where notice_id='$id_notice' and indexint=indexint_id ";
